...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("多云", R.mipmap.ic_partly_cloud_day, R.mipmap.bg_partly_cloudy_night),
    ...
    "WINDY" to Sky("大风", R.mipmap.ic_cloudy, R.mipmap.bg_wind),
    ...
    "STORM_SNOW" to Sky("大雪", R.mipmap.ic_heavy_snow, R.mipmap.bg_snow),
